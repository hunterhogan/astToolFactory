...
# TODO "ClassDefIdentifier": {'attribute': "'attributeType' = 'defaultValue'"}
...
listDocstring.append(Docstring(f"{identifierToolClass}.Attribute"
	...
	, {'value': aDocument("The base expression before the first dot, typically an `ast.Name` or another expression.")
